...
def control_loop():
    ...
    transient_time = 1 * 1/frequency # stop update control input for transient phase rum time (set a initial value by stopping control input during a little moments)
