...
> 2. Initially launch swing-up for pendulum inverting. (✅ 2026-02-10 clear, interface/plant/py/hardware/plant_with_swing_up.py, [demonstration with ctrl_arx_enc.cpp](https://youtu.be/5z65PVYJA_E))
