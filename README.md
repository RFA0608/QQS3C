...
2. Initially launch swing-up for pendulum inverting. (✅ 2026-02-13 clear(modified energy based), interface/plant/py/hardware/plant_with_swing_up.py, [demonstration video hyperlink with ctrl_arx_enc.cpp](https://youtu.be/IPi5QwssUeg))
